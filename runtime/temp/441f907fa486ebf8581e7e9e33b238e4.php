<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"E:\project\tptianyu\public/../application/admin\view\salary\index.html";i:1547639665;s:54:"E:\project\tptianyu\application\admin\view\layout.html";i:1549008459;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<title>工资总览 - 工资管理 - H-ui.admin v3.0</title>
...
<section class="Hui-article-box">
	<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页
		...
		工资管理
		<span class="c-gray en">&gt;</span>
		工资总览 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a> </nav>
	<div class="Hui-article">
		<article class="cl pd-20">
			...
			<table class="table table-border table-bordered table-bg">
				<thead>
					<tr>
						<th scope="col" colspan="10">全部工资</th>
					</tr>
					<tr class="text-c">
